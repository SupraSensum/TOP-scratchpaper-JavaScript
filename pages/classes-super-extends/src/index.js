...
class HotelRoomFood extends HotelRoom {
    constructor({ roomNumber, numOccupants, occupied, guestName, food }) {
        super({ roomNumber, numOccupants, occupied, guestName });
        this._food = food;
    }
